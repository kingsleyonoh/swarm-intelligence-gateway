...
import { mountSimulationUi, wireGlobeUpdates } from './simulation-ui-bootstrap.js';
...
const PANEL_DESCRIPTIONS: Record<string, string> = {
  'swarm-theater': 'Swarm intelligence predictions by theater. Each card shows what the configured AI swarm predicts will happen next. Click for the full intelligence brief.',
...
const intelTicker = mountSimulationUi(panelContainer);
...
if (globeContainer) {
  wireGlobeUpdates(globeContainer);
}
